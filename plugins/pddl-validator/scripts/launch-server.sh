...
#
# Creates a Python venv with pyvalidator and runs the MCP server.
# No Docker required — validation is pure Python via pip.
...
SERVER="$PLUGIN_DIR/server/validator_server.py"
