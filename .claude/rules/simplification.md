...
1. **Existing code check**: Search the codebase for existing scripts, patterns, or utilities. Especially check `plugins/pddl-solver/` for reference implementations of launch scripts, MCP servers, verify scripts, and skills. Do not duplicate.
